...
const Bloggg = ({ blogg, handleAddToBookMark }) => {
    const { title,cover_img,author_img,reading_time, author_name,posted_date,hashtags } = blogg;
    return (
        <div>
            ...
            <div className="flex justify-between items-center ">
                ...
                <div className="flex gap-2 items-center">
                    ...
                    <button onClick={() =>handleAddToBookMark(blogg)}><FaRegBookmark /></button>
                </div>
            </div>
